...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        '-c',
        '--component',
        default=UpdaterComponent.ALL,
        action='store',
        dest='component',
        choices={UpdaterComponent.ALL, UpdaterComponent.FFMPEG, UpdaterComponent.YTDL},
        help=f'updater components to update, default {UpdaterComponent.ALL}',
    )
    parser.add_argument(
        '-d',
        '--destination',
        default=DEF_EXTRACT_PATH,
        action='store',
        dest='destination',
